"""M6 Simulation Scene Launch — Gazebo + robot + objects + ground truth.

Phase 1: Establish the simulation scene with objects.
    Gazebo(m6_test_world.sdf) → spawn robot → controllers → bridge clock

Unlike m5_6_stress_test.launch.py which uses empty.sdf,
this launch uses a custom world with table + cube + cylinder,
providing objects for the robot to interact with.
"""

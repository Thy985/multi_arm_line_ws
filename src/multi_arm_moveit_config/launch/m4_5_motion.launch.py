"""M4.5 Motion + Coordination Validation launch.

Combined dual-arm URDF + MoveIt2 move_group + WorldModel + Safety.
Uses single CM architecture for MoveIt2 compatibility.
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    # MoveIt2 move_group - load YAML files and merge into dict
    ...
    # WorldModel
    nodes.append(TimerAction(period=5.0, actions=[Node(
